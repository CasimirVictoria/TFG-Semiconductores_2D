#+TITLE: Astrofisica. Tarea a entregar del Tema 6
...
Fijemonos en el átomo de Boro de la celdilla $\vec 0$. Este átomo tiene 3 primeros vecinos situados en las celdillas $(0, 0), (-1,0), (1,1)$, cuyas posiciones són
#+begin_src python :session :results output :exports both
...
y se encuentran a distancia src_python[:session]{norm(RN(-1,0)-RB(0,0))} {{{results(=0.5773502691896257=)}}}$ del átomo de boro de lba celdilla $\vec 0$.
