\documentclass[12pt,twoside]{article} %,twoside,a4paper
...
Els cristalls o \emph{estructures cristal·lines} són distribucions regulars d'àtoms en l'espai de posicions i els podem descriure associant a cadascun dels nucs d'una xarxa cristallina en l'espai de posicions un conjunt d'àtoms o base ({matemàticament és producte de \emph{convolució} de la base y la xarxa de nucs). En el cas del \emph{BN} tractem amb una base diatòmica, formada per un nucli de bor, $B$ i un de nitrogen, $N$. 
