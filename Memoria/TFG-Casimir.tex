...
\usepackage[left=2.5cm,right=2.5cm,top=3cm, bottom=3.3cm]{geometry}
%\usepackage{geometry}
...
\centering
\sageplot[width=6.5cm]{xarxaR, figsize=4}
\caption{Xarxa $2\pi$-recíproca}
\end{subfigure}
\begin{subfigure}[b]{0.4\textwidth}
\centering
\includegraphics[width=6.5cm]{../Grafiques/zona_brillouin.png}
...
\begin{center}
\includegraphics[width=14cm]{../Grafiques/Dispersio3ers.pdf}
\end{center}
