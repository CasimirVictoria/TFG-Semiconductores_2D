...
\label{sec:org150f40d}

\subsection{Clasificación de los vecinos}
\label{sec:orged2e5e1}
...
\eject \pdfpagewidth=320mm \pdfpageheight=340mm
...
\begin{equation}
\left[\begin{smallmatrix}3 \left(\phi^{BB}_{2r} + \phi^{BB}_{2ti}\right) & 0 & 0 & \frac{3 \left(\phi^{BN}_{1r} + \phi^{BN}_{1ti} + \phi^{BN}_{3r} + \phi^{BN}_{3ti}\right)}{2} & 0 & 0\\0 & 3 \left(\phi^{BB}_{2r} + \phi^{BB}_{2ti}\right) & 0 & 0 & \frac{3 \left(\phi^{BN}_{1r} + \phi^{BN}_{1ti} + \phi^{BN}_{3r} + \phi^{BN}_{3ti}\right)}{2} & 0\\0 & 0 & 6 \phi^{BB}_{2to} & 0 & 0 & 3 \left(\phi^{BN}_{1to} + \phi^{BN}_{3to}\right)\\\frac{3 \left(\phi^{BN}_{1r} + \phi^{BN}_{1ti} + \phi^{BN}_{3r} + \phi^{BN}_{3ti}\right)}{2} & 0 & 0 & 3 \left(\phi^{NN}_{2r} + \phi^{NN}_{2ti}\right) & 0 & 0\\0 & \frac{3 \left(\phi^{BN}_{1r} + \phi^{BN}_{1ti} + \phi^{BN}_{3r} + \phi^{BN}_{3ti}\right)}{2} & 0 & 0 & 3 \left(\phi^{NN}_{2r} + \phi^{NN}_{2ti}\right) & 0\\0 & 0 & 3 \left(\phi^{BN}_{1to} + \phi^{BN}_{3to}\right) & 0 & 0 & 6 \phi^{NN}_{2to}\end{smallmatrix}\right]
\end{equation}
